...
from config import ModelHyperParams, merge_cfg_from_list, InferTaskConfig,\
    encoder_data_input_fields, fast_decoder_data_input_fields
...
def prepare_infer_input(insts, src_pad_idx, bos_idx, n_head):
    ...
    src_word, src_pos, src_slf_attn_bias, src_max_len = pad_batch_data(
        [inst for inst in insts], src_pad_idx, n_head, is_target=False)
...
def infer(args):
    ...
    with fluid.dygraph.guard(place):
        ...
        generator, word_dict = transformer_reader('test')
        reader = paddle.batch(generator,
